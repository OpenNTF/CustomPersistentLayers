...
public class JavaBeanInterceptor implements MethodInterceptor {
	...
	private ArrayList<Field> cachedDominoFields;
	...
	public JavaBeanInterceptor() {
		super();
		cachedDominoFields = new ArrayList<Field>();
	...
	public void setTarget(Object target) {
		...
		this.target = target;
		cachedDominoFields = (ArrayList<Field>) ReflectionUtils.eachField(
				target.getClass(), new Predicate<Field>() {
		...
		for (Field field : cachedDominoFields) {
